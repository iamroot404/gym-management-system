...
public class addNew extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        getContentPane().add(jLabel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(630, 280, -1, -1));
        ...
        getContentPane().add(id, new org.netbeans.lib.awtextra.AbsoluteConstraints(400, 240, 200, -1));

        name.setFont(new java.awt.Font("Bahnschrift", 1, 14)); // NOI18N
        getContentPane().add(name, new org.netbeans.lib.awtextra.AbsoluteConstraints(400, 280, 200, -1));

        no.setFont(new java.awt.Font("Bahnschrift", 1, 14)); // NOI18N
        getContentPane().add(no, new org.netbeans.lib.awtextra.AbsoluteConstraints(400, 320, 200, -1));

        idno.setFont(new java.awt.Font("Bahnschrift", 1, 14)); // NOI18N
        getContentPane().add(idno, new org.netbeans.lib.awtextra.AbsoluteConstraints(710, 240, 200, -1));

        mail.setFont(new java.awt.Font("Bahnschrift", 1, 14)); // NOI18N
        getContentPane().add(mail, new org.netbeans.lib.awtextra.AbsoluteConstraints(710, 280, 200, -1));

        gender.setFont(new java.awt.Font("Bahnschrift", 1, 14)); // NOI18N
        gender.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "MALE", "FEMALE", "OTHERS" }));
        getContentPane().add(gender, new org.netbeans.lib.awtextra.AbsoluteConstraints(710, 320, 200, -1));
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        // TODO add your handling code here:
         if(id.getText().trim().isEmpty() ||name.getText().trim().isEmpty() || no.getText().trim().isEmpty() || idno.getText().trim().isEmpty()|| mail.getText().trim().isEmpty()){
          ...
          int opt = JOptionPane.showConfirmDialog(null, "Please confirm Member details before Submitting", "Submit", JOptionPane.YES_NO_OPTION);
        if(opt==0){
        try{
            ...
            String sql = "INSERT INTO registration(id,name,mobile,idno,email,gender,status) VALUES('"+mid+"','"+mname+"','"+mno+"','"+midno+"','"+mmail+"','"+mgender+"', 'NOT PAID')";
